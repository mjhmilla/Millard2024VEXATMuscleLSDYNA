...
c############################################
     ...
     +  aniType)
      ...
      if(useHuman) then 
        xPts = reshape((/
     +   -1.000000000000e+00,-9.790215973564e-01,-9.000000000000e-01,
     +   -9.000000000000e-01,-8.647872901961e-01,-8.000000000000e-01,
     +   -8.000000000000e-01,-5.464108450519e-01,-4.000000000000e-01,
     +   -4.000000000000e-01,-1.257141830353e-01,0.000000000000e+00,
     +   0.000000000000e+00,2.187500000000e-03,2.500000000000e-03,
     +   2.500000000000e-03,2.812500000000e-03,5.000000000000e-03,
     +   5.000000000000e-03,2.792809343818e-02,5.250000000000e-02,
     +   5.250000000000e-02,6.224130583802e-02,1.000000000000e-01/),
     +   shape(xPts))
     ...
     +   shape(yEnd))
        ...
        dydxEnd = reshape((/
     +   1.220703126424e-07,1.500000000000e-01/),
     +   shape(dydxEnd))
     ...
     +   shape(d2ydx2End))
      ...
      if(useFeline) then
        ...
        xPts = reshape((/
     +   -1.000000000000e+00,-9.719991554545e-01,-9.000000000000e-01,
     +   -9.000000000000e-01,-8.690634942934e-01,-8.000000000000e-01,
     +   -8.000000000000e-01,-5.219536138042e-01,-4.000000000000e-01,
     +   -4.000000000000e-01,-7.583303225648e-02,0.000000000000e+00,
     +   0.000000000000e+00,2.187500000000e-03,2.500000000000e-03,
     +   2.500000000000e-03,2.812500000000e-03,5.000000000000e-03,
     +   5.000000000000e-03,9.492910695749e-03,5.250000000000e-02,
     +   5.250000000000e-02,6.406767685614e-02,1.000000000000e-01/),
     +   shape(xPts))
     ...
     +   shape(yEnd))
        ...
        dydxEnd = reshape((/
     +   1.220703120267e-07,2.400000000000e-01/),
     +   shape(dydxEnd))
